...
<!--                <li class="nav-item">-->
<!--                    <a href="?mod=products&action=cate" title="" class="nav-link">Danh mục sản phẩm</a>-->
<!--                </li>-->
            </ul>
        </li>
<!--        <li class="nav-item">-->
...
<!--                </li>-->
<!--                <li class="nav-item">-->
<!--                    <a href="?mod=users" title="" class="nav-link">Danh sách khách hàng</a>-->
<!--                </li>-->
<!--            </ul>-->
<!--        </li>-->
        <li class="nav-item">
...
<!--            <ul class="sub-menu">-->
<!--                <li class="nav-item">-->
<!--                    <a href="user/danh-sach-thanh-vien.html" title="" class="nav-link">-->
